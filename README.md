...
## Skills
 ...
 - obsidian-eval-query - This helps agents run queries against obsidian.md notebooks using the obsidian-cli
 - go-docker-socket - This query helps write golang programs that access the Docker socket. This is unexpectedly hard as Docker/Moby reorganized their modules and many models currently (March 2026) use the old depreacated version by default.